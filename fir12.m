...
audio = audio / max(abs(audio)); % Normalize to avoid clipping
...
% Design FIR bandpass filter with Hamming window for N=12
N = 12; % Filter order
...
audiowrite('filtered_audio_FIR_Hamming_N12_300to1500.wav', filtered_signal, fs);
...
% Display a summary
disp('Filtered audio saved as: filtered_audio_FIR_Hamming_N12_300to1500.wav');
